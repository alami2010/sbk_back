...
class DepartementResourceIT {
    ...
    public static Departement createEntity(EntityManager em) {
        Departement departement = new Departement().region_code(DEFAULT_REGION_CODE).code(DEFAULT_CODE).name(DEFAULT_NAME);
        return departement;
    }
    ...
    public static Departement createUpdatedEntity(EntityManager em) {
        Departement departement = new Departement().region_code(UPDATED_REGION_CODE).code(UPDATED_CODE).name(UPDATED_NAME);
        return departement;
    }
    ...
    void getAllDepartements() throws Exception {
        ...
        restDepartementMockMvc
            ...
            .andExpect(jsonPath("$.[*].region_code").value(hasItem(DEFAULT_REGION_CODE)))
    ...
    void getDepartement() throws Exception {
        ...
        restDepartementMockMvc
            ...
            .andExpect(jsonPath("$.region_code").value(DEFAULT_REGION_CODE))
